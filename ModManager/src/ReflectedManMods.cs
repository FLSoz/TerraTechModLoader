...
namespace ModManager
{
    internal class ReflectedManMods
    {
        ...
        internal static readonly FieldInfo m_WaitingOnDownloads = typeof(ManMods).GetField("m_Mods", BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic);
